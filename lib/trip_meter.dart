...
class trip_meter extends StatefulWidget{

  @override

  State<trip_meter > createState() =>_trip_meter ();



}
class _trip_meter  extends State<trip_meter >{
  @override
                    ...
                    children: [
                        ...
                        child: ElevatedButton(onPressed:(){
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text("Trip Meter",textAlign:TextAlign.start,style:TextStyle(color:Colors.white,fontSize:40,fontWeight:FontWeight.bold),),
                            ),
                          ],
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(onPressed:(){
                          ...
                          children: [
                            ...
                            Text("Trip A",textAlign:TextAlign.start,style:TextStyle(color:Colors.white,fontSize:40,fontWeight:FontWeight.bold),),
                          ],
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(onPressed:(){
                          ...
                          mainAxisAlignment:MainAxisAlignment.start,
                          children: [
                            Text("Trip B",textAlign:TextAlign.start,style:TextStyle(color:Colors.white,fontSize:40,fontWeight:FontWeight.bold),),
                          ],
                        ),style:ElevatedButton.styleFrom(backgroundColor:Colors.black,side:BorderSide(color:Colors.white,width:2),),),
                      ),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(onPressed:(){
                          ...
                          mainAxisAlignment:MainAxisAlignment.start,
                          children: [
                            Text("Last Trip",textAlign:TextAlign.start,style:TextStyle(color:Colors.white,fontSize:40,fontWeight:FontWeight.bold),),
                          ],
                        ),style:ElevatedButton.styleFrom(backgroundColor:Colors.black,side:BorderSide(color:Colors.white,width:2)),),
                      ),
