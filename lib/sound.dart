                    ...
                    children: [
                        ...
                        child: ElevatedButton(onPressed:(){
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text("Sound",textAlign:TextAlign.start,style:TextStyle(color:Colors.white,fontSize:40,fontWeight:FontWeight.bold),),
                            ),
                          ],
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(onPressed:(){
                          ...
                          children: [
                            ...
                            Text("On",textAlign:TextAlign.start,style:TextStyle(color:Colors.white,fontSize:40,fontWeight:FontWeight.bold),),
                          ],
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(onPressed:(){
                          ...
                          mainAxisAlignment:MainAxisAlignment.start,
                          children: [
                            Text("Off",textAlign:TextAlign.start,style:TextStyle(color:Colors.white,fontSize:40,fontWeight:FontWeight.bold),),
                          ],
                        ),style:ElevatedButton.styleFrom(backgroundColor:Colors.black,side:BorderSide(color:Colors.white,width:2),),),
                      ),
